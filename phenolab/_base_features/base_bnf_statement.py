...
INNER JOIN INTELLIGENCE_DEV.AI_CENTRE_DEV.BSA_BNF_LOOKUP b
    ON TRY_TO_NUMBER(m.BNF_REFERENCE) = b."BNF Subparagraph Code"
WHERE m.BNF_REFERENCE IS NOT NULL
    AND m.BNF_REFERENCE != ''
    AND TRY_TO_NUMBER(m.BNF_REFERENCE) IS NOT NULL
