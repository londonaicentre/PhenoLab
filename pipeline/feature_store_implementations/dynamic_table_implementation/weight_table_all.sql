-- code to be run in snowflake with a CREATE OR REPLACE TABLE intelligence_dev.ai_centre_dev.weight_table_all AS 
-- makes table with multiple rows per person who has had BMI coding 
...
categorised_data AS (
    ...
    SELECT *,
        CASE 
            ...
            WHEN value IS NULL AND code_description ILIKE '%Body mass index 40+%' THEN 'Obese Class III'
