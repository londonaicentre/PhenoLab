...
def create_demographic_prevalence_table() -> str:
    """
...
def main():
    ...
    query = create_demographic_prevalence_table()
    feature_store_manager.add_new_feature(
        feature_name = "Demographic_denominator_count3",
        feature_desc = "Demographic prevalence of key phenotypes",
